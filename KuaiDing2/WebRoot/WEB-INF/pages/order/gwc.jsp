...
<link rel="stylesheet" href="<%=path%>/pages/Order/css/gwc.css" type="text/css"/>
       ...
       <div class="rst-right">
          <ul class="rst-nav2">
                <li class="bg3">
                    ...
                    <h4>订餐步骤</h4>
                    <img src="<%=path%>/pages/Order/images/ddbz.png" />
                </li>
            </ul>
       </div>
    </div>
        ...
        <div class="order-left">
            <table width="100%" border="0" cellspacing="1" cellpadding="0"> 
                ...
                <tr>
                    ...
                    <td>
                        <h5>
                           <button class="btn1">-</button>1<button class="btn1">+</button>
                        </h5>
                    </td>
                    <td>
                        <h5>￥18.00</h5>
            ...
            <div class="info">
                <ul>
                    ...
                    <li>
                       <form>
                          <h5>
                              <span class="span1">送餐时间</span>
                              <input class="input1" name="time" id="time" type="text" placeholder="立即送达" required />
                          </h5>
                          <h5>
                              <span class="span1">订单备注</span>
                              <input class="input1" name="remarks" id="remarks" type="text" placeholder="" />
                          </h5>
                          <button class="btn2">确认下单</button>
                       </form>
                    </li>
                </ul>
            </div>
