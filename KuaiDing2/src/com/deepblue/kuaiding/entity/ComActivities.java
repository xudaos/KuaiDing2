...
/**
 * ComActivities entity. @author MyEclipse Persistence Tools
 */

public class ComActivities implements java.io.Serializable {
	...
	/** default constructor */
	public ComActivities() {
	}

	/** minimal constructor */
	public ComActivities(String objectid, String name, String title,
			String pic, String content, Timestamp vardate, Timestamp retime,
